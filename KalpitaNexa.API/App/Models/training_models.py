...
class QuizResultRequest(BaseModel):
    ...
    questions_json: Optional[str] = None   # JSON string of all Q&A
...
class GenerateShortsRequest(BaseModel):
    day_folder_name: str = Field(..., description="Name of the Day folder on SharePoint")
    force_reclean: bool = Field(False, description="Re-run transcript cleaning even if cached version exists")
